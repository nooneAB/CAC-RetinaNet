...
#CLASS_NAMES = ['ship']
# 数据集路径
DATASET_ROOT = '/mnt/93ae2f5a-f82d-4630-a157-ca366fc5e2e9/ljz/QueryDet-PyTorch-main/data'
ANN_ROOT = os.path.join(DATASET_ROOT, 'coco/annotations')

TRAIN_PATH = os.path.join(DATASET_ROOT, 'coco/annotations/train_images')
VAL_PATH = os.path.join(DATASET_ROOT, 'coco/annotations/val_images')
