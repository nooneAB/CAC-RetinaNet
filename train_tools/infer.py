...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument("--config-file", default="/mnt/93ae2f5a-f82d-4630-a157-ca366fc5e2e9/ljz/QueryDet-PyTorch-main/configs/coco/querydet_test.yaml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
